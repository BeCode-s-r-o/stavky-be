...
function generateInvoiceTable(doc, invoice) {
  ...
  generateTableRow(
    ...
    "Základ DPH 20%",
    "",
    formatCurrency((invoice.subtotal-invoice.discountValue) / 1.2)
  );
  ...
  generateTableRow(
    ...
    "DPH 20%",
    "",
    formatCurrency((invoice.subtotal-invoice.discountValue) - (invoice.subtotal-invoice.discountValue) / 1.2)
  );
